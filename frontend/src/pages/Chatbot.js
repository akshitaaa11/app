...
const Chatbot = () => {
  ...
  const exportChat = () => {
    ...
    a.href = url;
    a.download = `scholarbot-chat-${new Date().toISOString().split('T')[0]}.txt`;
      ...
      <div className="glass border-b border-white/10 p-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="glass-blue p-3 rounded-xl animate-glow">
              <Bot className="h-6 w-6 text-blue-300" />
            </div>
            <div>
              <h1 className="text-lg font-semibold text-white">ScholarBot Assistant</h1>
              <p className="text-sm text-gray-400">Your personal scholarship advisor</p>
            </div>
          </div>
